...
//  static_assert(std::is_base_of<Dune::XT::Functions::GlobalFunctionInterface<E, R, r, R, r, rC>, GlobalFunctionType>::value, "");
public:
  ...
  virtual RangeType evaluate(const RangeType& u, const EntityType& entity, const DomainType& /*x_local*/,
                             const double /*t_*/ = 0) const
  {
    return checkerboard_function_.localizable_function(entity).evaluate(u);
  }

  virtual RhsJacobianRangeType jacobian(const RangeType& u, const EntityType& entity, const DomainType& /*x_local*/, const double /*t_*/ = 0) const
  {
