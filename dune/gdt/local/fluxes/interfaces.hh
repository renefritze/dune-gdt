...
public:
  ...
  // TODO: determine correct type
  typedef typename XT::Functions::LocalfunctionSetInterface<DummyEntityType, R, r, R, r, rC>::JacobianRangeType RhsJacobianRangeType;
  ...
  virtual RhsJacobianRangeType jacobian(const RangeType& /*u*/, const EntityType& /*entity*/, const DomainType& /*x_local*/,
                             const double /*t_*/ = 0) const
  {
