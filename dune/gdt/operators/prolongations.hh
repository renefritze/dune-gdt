...
public:
  ...
  template< class GPS, int pS, class R, size_t r, size_t rC, class VS, class GPR, int pR, class VR >
  inline void apply(const ConstDiscreteFunction
      < Spaces::CG::PdelabBased< GPS, pS, R, r, rC >, VS >& source,
                    DiscreteFunction< Spaces::DG::PdelabBased< GPR, pR, R, r, rC >, VR >&
                    range) const
  {
    prolong_onto_dg_fem_localfunctions_wrapper(source, range);
  }
  ...
  template< class GPS, int pS, class R, size_t r, size_t rC, class VS, class GPR, int pR, class VR >
  inline void apply(const ConstDiscreteFunction
      < Spaces::DG::PdelabBased< GPS, pS, R, r, rC >, VS >& source,
                    DiscreteFunction< Spaces::CG::PdelabBased< GPR, pR, R, r, rC >, VR >&
                    range) const
  {
    prolong_onto_dg_fem_localfunctions_wrapper(source, range);
  }
